...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 border-b border-white/10 z-50 bg-[#025c0e] backdrop-blur-sm text-white">
      <div className="container mx-auto px-4 py-2 sm:px-6 lg:px-8">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            {Object.keys(menuItems).map((key) => (
              <div key={key} className="relative">
                ...
                {/* Dropdown Menu with transparent blur */}
                {activeDropdown === key && (
                  <div className="absolute left-0 mt-2 w-screen max-w-md bg-[#025c0e] backdrop-blur-sm rounded-md shadow-lg py-1 text-black z-50">
        ...
        {isMenuOpen && (
          <div className="lg:hidden bg-white/10 backdrop-blur-sm px-4 py-2 space-y-2 rounded-md text-black">
