...
import bannerImage from "../assets/Tea.jpg";

const About = () => {
  return (
    <>
      {/* Hero Banner */}
      <section className="relative w-full h-52 md:h-60 lg:h-72">
        <img
          src={bannerImage} // Path to your uploaded image
      ...
      {/* Content Section */}
      <section className="bg-gradient-to-b from-white to-green-50 py-12 px-6 md:px-16">
        {/* Intro */}
        <div className="max-w-5xl mx-auto text-center mb-16">
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-3xl mx-auto">
            Welcome to Agrowcell International Private Limited, your trusted
            partner in sourcing the finest Ceylon spices, tropical fruits, and
            premium coconut-related products from the heart of Sri Lanka.
            Established with a vision to bring the authentic flavors of the
            island to the world, we take immense pride in delivering nature’s
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          <div className="bg-green-50/80 backdrop-blur-md shadow-lg rounded-2xl p-6 hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-gray-700 leading-relaxed">
              To be the world’s leading exporter of Ceylon’s finest agricultural
              products, renowned for our commitment to sustainable and ethical
              sourcing, innovative product development, and exceptional customer
              service.
            </p>
          </div>
          <div className="bg-green-50/80 backdrop-blur-md shadow-lg rounded-2xl p-6 hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-gray-700 leading-relaxed">
              To elevate the global appreciation for the unique flavors, aromas,
              and versatility of Ceylon’s agricultural bounty, while empowering
              Sri Lankan farmers and communities through sustainable and ethical
              practices.
            </p>
          </div>
        </div>
