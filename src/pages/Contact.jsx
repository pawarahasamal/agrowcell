...
import bannerImage from "../assets/Tea.jpg"; // <-- Add your uploaded image path
...
const Contact = () => {
  return (
    <div className="w-full min-h-screen">
      ...
      {/* Contact Content */}
      <div className="bg-gradient-to-b from-green-50 to-green-100 py-16 px-4 sm:px-6 lg:px-20">
        {/* Section Title */}
              ...
              <ul className="space-y-5 text-gray-700">
                ...
                <li className="flex items-center gap-3 hover:text-green-800 transition-colors">
                  ...
                  <span className="font-medium">
                    123 Agrowcell Street, Colombo, Sri Lanka
                  </span>
                </li>
